...
PROVIDER_REGISTRY: Dict[str, ProviderConfig] = {
    ...
    # that correct when base_url points at the proxy. NOTE: the "openai-api"
    # entry above is a SEPARATE id and does NOT make bare "openai" resolve. See
    # traia-agent-workspaces docs/specs/llm-egress-proxy.md.
